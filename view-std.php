...
if (isset($_GET['delete_email'])) {
    ...
    $deleteSql = "DELETE FROM students WHERE email = '$deleteEmail'";
    if (mysqli_query($conn, $deleteSql)) {
        header("Location: view-std.php"); // Redirect to the same page after deletion
    } else {
...
<body>
    <div class="bar">
        ...
        <div class="header">
            <div class="right">
                <p style="font-weight: bold; font-size: 20px; padding-left: 18px;">Students</p>
                <div id="datetime">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td><a class="edit-button" href="upt-std.php?email=' . htmlspecialchars($row['email']) . '">Edit</a></td>';
            echo '<td><a class="edit-button" href="view-std.php?delete_email=' . htmlspecialchars($row['email']) . '">Delete</a></td>'; // Add the delete button
        echo "</tr>";
        }
        ?>
    </table>
