                    ...
                    <ul class="ul-main">
                        ...
                        <li class="buton"><button class="button" id="teacher-btn">Teacher</button>
                            <ul class="ul-sub" id="teacher">
                                <li class="nav-elmnt"><a href="#" class="nav-elmnt">Add Teacher</a></li>
        ...
        <div class="header">
            ...
            <div class="page">
                <div class="form">
                    ...
                    <form action="addteach.php" method="POST" id="form">
                            <div >
                                <h3
                            ...
                            <div class="fullname">
                                <div class="name"><label for="firstname" class="fname">First Name</label><br>
                                    <input type="text" id="firstname" class="firstname" name="firstname" placeholder="First name" maxlength="30" pattern="[A-Za-z]+" 
                                        required>
                                </div>
                                <div class="name">
                                    <label for="lastname" class="lname">Last Name</label><br>
                                    <input type="text" id="lastname" class="lastname" name="lastname" placeholder="Last name" maxlength="30" pattern="[A-Za-z]+" 
                                        required>
                                </div>
                            </div>
                            <div class="email-1">
                            ...
                            <div class="pass">
                                <label for="password" class="password-label">Department</label><br>
                                <input type="text" id="password" class="password" name="department" placeholder="Department"
                                    required>
                            </div>
                            <div class="date">
